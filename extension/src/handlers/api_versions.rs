...
/// Fixed by build and configuration, not a controller election, so the epoch never advances.
const FEATURES_EPOCH: i64 = 0;

/// Clients pick protocol behaviour from these levels, not API version ranges.
