...
/// Partitions whose committed offset for this group is staged in an unfinished transaction;
/// `RequireStable` (v7+) asks to wait rather than read a retractable offset.
