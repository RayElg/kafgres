...
ADVERTISED = {
    ...
    ALTER_PARTITION_REASSIGNMENTS: (0, 1),
    ...
    LIST_CONFIG_RESOURCES: (1, 1),
    DESCRIBE_TOPIC_PARTITIONS: (0, 0),
    SHARE_GROUP_HEARTBEAT: (1, 1),
    SHARE_GROUP_DESCRIBE: (1, 1),
    SHARE_FETCH: (1, 2),
    SHARE_ACKNOWLEDGE: (1, 2),
    ADD_RAFT_VOTER: (0, 1),
    REMOVE_RAFT_VOTER: (0, 0),
    INITIALIZE_SHARE_GROUP_STATE: (0, 0),
    READ_SHARE_GROUP_STATE: (0, 0),
    WRITE_SHARE_GROUP_STATE: (0, 1),
    DELETE_SHARE_GROUP_STATE: (0, 0),
    READ_SHARE_GROUP_STATE_SUMMARY: (0, 1),
    STREAMS_GROUP_HEARTBEAT: (0, 0),
    STREAMS_GROUP_DESCRIBE: (0, 0),
    DESCRIBE_SHARE_GROUP_OFFSETS: (0, 1),
